...
String _authMessage(String code) => switch (code) {
      ...
      'resend-cooldown' => 'يرجى الانتظار قليلاً قبل طلب رمز جديد.',
      'username-already-in-use' => 'اسم المستخدم مستخدم بالفعل. يرجى اختيار اسم آخر.',
      'weak-password' => 'كلمة المرور ضعيفة. يجب ألا تقل عن 6 أحرف.',
      'invalid-credentials' => 'اسم المستخدم أو كلمة المرور غير صحيحة.',
      'account-not-found' =>
        'إذا كان هذا الحساب موجوداً، فقد تم إرسال رمز التحقق إلى رقم الجوال المسجل.',
      'phone-already-registered' =>
        'رقم الجوال هذا مسجّل بالفعل. يرجى تسجيل الدخول أو استخدام رقم آخر.',
